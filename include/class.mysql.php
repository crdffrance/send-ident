...
class MysqlConnection {
	...
	public function __construct($host='', $db='', $user='', $pass='') {
		...
		try {
			...
			$this->connection = new PDO("mysql:dbname={$this->db};host={$this->host};charset=UTF8", $this->user, $this->pass);
 ...
 * @author Beaker Studio
 */
abstract class MysqlWhereBase extends MysqlBase {
 ...
 * @author Beaker Studio
 */
class MysqlSelect extends MysqlWhereBase {
	...
	protected function build_column_name($column, $alias=false, $func=false) {
		...
		$last_exploded = explode('.', $column);
		$last = end($last_exploded);
 ...
 * @author Beaker Studio
 */
class MysqlUpdate extends MysqlWhereBase {
 ...
 * @author Beaker Studio
 */
class MysqlDelete extends MysqlWhereBase {
 ...
 * @author Beaker Studio
 */
class MysqlInsert extends MysqlBase {
